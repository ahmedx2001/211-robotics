...
/*-----------------------------------------------------------------------------*/
/** @brief    ROBOTC warning elination                                    */
/*-----------------------------------------------------------------------------*/
/** @details
...
{
    SmartMotorGetPtr(0);
    SmartMotorControllerGetPtr(0);
    SmartMotorGetSpeed(0);
    SmartMotorGetCurrent(0);
    SmartMotorGetTemperature(0);
    SmartMotorGetLimitCmd(0);
    SmartMotorSetLimitCurent(0);
    SmartMotorSetFreeRpm(0,0);
    SmartMotorSetSlewRate(0);
    SmartMotorGetControllerCurrent(0);
    SmartMotorGetControllerTemperature(0);
    SmartMotorSetControllerStatusLed(0,0);
    SmartMotorSetPowerExpanderStatusPort(0);
    SmartMotorPtcMonitorEnable();
    SmartMotorCurrentMonitorEnable();
    SmartMotorRun();
    SmartMotorDebugStatus();
    ...
    MotorReleaseSemaphore();
    SmartMotorsInit();
    SmartMotorLinkMotors(0,0);
    SmartMotorsSetEncoderGearing(0,0);
    SmartMotorsAddPowerExtender(0);
    SmartMotorSetRpmSensor(0,0,0);
    WarningEliminate();
}
